...
global.github=process.env.GITHUB|| "https://github.com/jayrad2005/botggs";
...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2349163481768,2349059032370,2348140351556,2347064159972,2349121454286";
...
module.exports = {
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "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",
  ...
  LANG: ( process.env.THEME ||  "BATEMAN"  ).toUpperCase(),
